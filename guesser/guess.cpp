...
//---------Parse the command line------------------------//
    ...
    inputDicFileName[0] = model_path + "dictionaries.txt";
...
#else
    if (!processProbFromFile(numWords, (char *) "digits/")) {
#endif
...
#else
    if (!processProbFromFile(specialWords, (char *) "special/")) {
#endif
...
bool processBasicStruct(pqueueType *pQueue, ntContainerType **dicWords, ntContainerType **numWords,
    ...
    bool badInput;
#ifdef _WIN32
    std::string file = model_path + "grammar\\structures.txt";
